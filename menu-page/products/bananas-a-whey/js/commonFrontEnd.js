$(document).ready(function() {
  $.get(BaseUrl + "WebServices/IMediaDetails.asmx/GetGlossaryTerms", function(
    data
  ) {
    $(data).each(function() {
      var term = this.Term;
      ...
      $("p:contains(" + term + "), li:contains(" + term + ")")
        .not(".cd-nav li, .accordion li")
        .each(function() {
          var html = $(this).html();
  ...
  $(".password-hide").hide();
  // toggles show/hide of password field text
  $(".password-show").click(function() {
    $(".password-show").hide();
    $(".password-hide").show();
    $("#LoginControl_Password").attr("type", "text");
  });
  $(".password-hide").click(function() {
    $(".password-hide").hide();
    $(".password-show").show();
    $("#LoginControl_Password").attr("type", "password");
  });
});
